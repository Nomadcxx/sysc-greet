...
description: "sysc-greet ends Hyprland greeter support in ~3 months. It remains functional until then."
---
...
Migrate to [cagebreak](/docs/compositors/cagebreak), the Hyprland replacement, or [niri](/docs/compositors/niri), the default.
...
Change `kb_layout = us` to your preferred layout. See [Keyboard Layout](../configuration/keyboard-layout) for details.
