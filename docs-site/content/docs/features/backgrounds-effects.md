...
description: "sysc-greet includes animated background effects and ASCII text effects."
---
...
See [Custom Themes](../configuration/themes#custom-themes) for creating your own themes.
