---
title: "Sway Setup"
description: "Configuration for running sysc-greet with the Sway Wayland compositor."
---
...
Change `xkb_layout "us"` to your preferred layout. See [Keyboard Layout](../configuration/keyboard-layout) for details.
